...
Route::prefix('cobrancas')->group(function () {
    ...
    Route::post('/enviar/{id}', [CobrancaController::class, 'enviar']);
    Route::get('/vencidos', [CobrancaController::class, 'vencidos']);
    Route::get('/historico/{faturaId}', [CobrancaController::class, 'historico']);
});
